...
namespace EMX.HierarchyPlugin.Editor
{
	class Cache
	{
        ...
        */
		...
		static Dictionary<int, HierarchyObject> m_instanceIdToHierObject_0 = new Dictionary<int, HierarchyObject>();
		static Dictionary<int, HierarchyObject> m_instanceIdToHierObject_1 = new Dictionary<int, HierarchyObject>();
